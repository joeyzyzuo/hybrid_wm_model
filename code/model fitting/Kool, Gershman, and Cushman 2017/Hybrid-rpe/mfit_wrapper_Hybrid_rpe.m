...
% run optimization
params = set_opts_Hybrid_rpe;
f = @(x,data) Hybrid_rpe_rllik(x,data);
results = mfit_optimize(f,params,data,nstarts);
save('./results_kool2017_Hybrid_rpe.mat', 'results');
...
writetable(t, ['./params_kool2017_Hybrid_rpe.csv'], 'WriteRowNames',true,'Delimiter',';');
