...
% run optimization
params = set_opts_Hybrid_wm;
f = @(x,data) Hybrid_wm_rllik(x,data);
results = mfit_optimize(f,params,data,nstarts);

save('./results_kool2017_Hybrid_wm.mat', 'results');
...
writetable(t, ['./params_kool2017_Hybrid_wm.csv'], 'WriteRowNames',true,'Delimiter',';');
