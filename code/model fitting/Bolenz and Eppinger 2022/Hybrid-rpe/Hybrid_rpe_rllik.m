...
function  [LL, dtQ] = Hybrid_rpe_rllik(x,subdata,opts)
...
w_low_gain = y(6);        % mixing weight RL_low_stake
w_high_gain = y(7);       % mixing weight RL_high_stake
w_low_loss = y(8);      % mixing weight WM_stable
w_high_loss = y(9);     % mixing weight WM_variable
