...
function  LL = Hybrid_lwm_rllik(x,subdata,opts)
...
wwm = y(4);        % mixing weight RL_low_stake
...
W2 = zeros(2,1);         % Q(s,a): Second-stage WM values
...
for t = 1:N
    ...
    if s2==1
        W2(2) = W2(2) + decay_fai * (0-W2(2)); 
    else
        W2(1) = W2(1) + decay_fai * (0-W2(1));
    end
end