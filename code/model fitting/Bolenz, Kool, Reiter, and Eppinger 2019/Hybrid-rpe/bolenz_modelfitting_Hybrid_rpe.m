...
function bolenz_modelfitting_Hybrid_rpe
...
save('./results_bolenz_Hybrid_rpe.mat', 'results');
...
for m = 1:nrmodels
    ...
    writetable(t, ['./params_bolenz_Hybrid_rpe.csv'], 'WriteRowNames',true,'Delimiter',';');
end
end