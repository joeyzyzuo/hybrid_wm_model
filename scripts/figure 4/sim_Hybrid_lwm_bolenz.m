...
function sim_Hybrid_lwm_bolenz
...
% create output file
rng(111);
fileID = fopen('./trialdata_Hybrid_lwm_bolenz_sim.csv' ,'w');
...
results = importdata("./results_bolenz_Hybrid_lwm.mat");
x = results.x;
subID = results.subID;
